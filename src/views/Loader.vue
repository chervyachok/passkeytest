<template>
    <div tabindex="0" class="vld-overlay is-full-page" :class="{ 'is-active': $loader.enabled }" aria-busy="true"
        aria-label="Loading" style="z-index: 99999999;">
        <div class="vld-background" ></div>
        <div class="vld-icon">
            <svg viewBox="0 0 120 30" xmlns="http://www.w3.org/2000/svg" width="100" height="100">
